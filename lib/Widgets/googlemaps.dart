...
Widget googleMap(BuildContext context, double lat, double lon, Position myPos) {
  late GoogleMapController mapController;

  var camPos =
      CameraPosition(target: LatLng(myPos.latitude, myPos.longitude), zoom: 16);
  ...
  return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        }else if(snapshot.hasError){return Text(snapshot.error.toString());} else {
